...
if st.button('Predict Price'):
    ...
    column_names = ['Company', 'TypeName', 'Ram', 'Weight', 'Touchscreen', 
    ...
    # Predict the price
    try:
        predicted_price = np.exp(pipe.predict(query_df))  # If log-transformed, use exp
        predicted_price = math.floor(int(predicted_price)) 
